...
Use `.ai/PROMPTS.md` for task entry points. Apply `.ai/core/quality-gates.md` before completion and report actual evidence. Do not commit, push, open a pull request, update a ticket, deploy, access production, or perform destructive work without explicit user authorization.
